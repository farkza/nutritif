    ...
    <div>
      ...
      <div className="recipes-section">
        ...
        <div className="filter-buttons">
          <button className="filter-btn active">Tout (3)</button>
          <button className="filter-btn">Petit-déjeuner (1)</button>
          <button className="filter-btn">Déjeuner (2)</button>
          <button className="filter-btn">Dessert (0)</button>
        </div>
